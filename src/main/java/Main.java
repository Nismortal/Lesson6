...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String substring = "ñòðàäà"; // поменяли кодировку на windows-1251, тк в другом случае оно не распознавалось
        //ñòðàäà - êîðåíü ñëîâà ñòðàäàíèå, ÷òî îáåñïå÷èâàåò íåçàâèñèìîñòü îò ðåãèñòðà
